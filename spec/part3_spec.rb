...
describe 'BookInStock' do
  ...
  describe 'getters and setters' do
    ...
    it 'is able to change ISBN' do
      @book.isbn = 'isbn2'
      expect(@book.isbn).to eq('isbn2')
    end

    it 'is able to change price' do
      @book.price = 300.0
  ...
  describe 'constructor' do
    it 'rejects invalid ISBN number' do
